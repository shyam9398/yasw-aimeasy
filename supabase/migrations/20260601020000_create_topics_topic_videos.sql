...
drop policy if exists "topics anon select" on public.topics;
drop policy if exists "topic videos anon select" on public.topic_videos;

create policy "topics anon select" on public.topics for select to anon using (true);
create policy "topic videos anon select" on public.topic_videos for select to anon using (true);
